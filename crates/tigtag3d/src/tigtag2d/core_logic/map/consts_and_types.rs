...
// ★teitag3dでは、マップサイズをtigtag(2d)と同値に設定する（画面サイズとマップサイズを連動させない）
pub const MAP_WIDTH_IN_CELLS: i32 = 25; // w <= SCREEN_GRIDS_WIDTH;
pub const MAP_HEIGHT_IN_CELLS: i32 = 19 - 2; // h <= SCREEN_GRIDS_HEIGHT - 2;
